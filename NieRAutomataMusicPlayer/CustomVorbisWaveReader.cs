...
namespace NieRAutomataMusicTest
{
    ...
    /// Returns and sets Position as samples instead of bytes.
    /// </summary>
    public class CustomVorbisWaveReader : NAudio.Wave.WaveStream, NAudio.Wave.ISampleProvider, NAudio.Wave.IWaveProvider
    {
        NVorbis.VorbisReader _reader;
        NAudio.Wave.WaveFormat _waveFormat;

        public CustomVorbisWaveReader(string fileName)
        {
        ...
        public CustomVorbisWaveReader(System.IO.Stream sourceStream)
        {
        ...
        {
            get { return _reader.TotalSamples; }
        }
        ...
        public override long Position
        {
            get
            {
                return _reader.DecodedPosition;
            }
            set
            {
